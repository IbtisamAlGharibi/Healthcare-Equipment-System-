/* ============================================================
   ...
   async function loadEquipmentPerLab(tbodySelector) {
     try {
       ...
       const grouped = groupCount(data, (e) => e.laboratoryName);
   ...
   async function loadReservationsPerLab(tbodySelector) {
     try {
       ...
       const grouped = groupCount(data, (r) => r.laboratoryName);
       renderPairTable(tbodySelector, grouped);
     } catch (err) {
       renderPairTable(tbodySelector, []);
     }
   ...
   function renderLabs(labs) {
     ...
     tbody.innerHTML = labs
       ...
       <tr>
         ...
         <td class="td-actions"><div class="cell-actions">
   ...
   async function onSaveEquip() {
     ...
     const existing = id ? allEquipment.find((x) => equipId(x) === id) : null;
     const payload = {
      ...
      function renderReservations(list) {
        ...
        tbody.innerHTML = list
          ...
          <tr>
            ...
            <td class="td-actions" style="white-space:nowrap;"><div class="cell-actions">
              ${
